...
(function() {
  ...
  AppEnv = (function() {
    function AppEnv(options) {
      ...
      this.port = getPort(this, options);
      this.bind = getBind(this, options);
  ...
  getPort = function(appEnv, options) {
    var port, portString;
  ...
  getBind = function(appEnv, options) {
    var _ref;
    return ((_ref = appEnv.app) != null ? _ref.host : void 0) || options.bind || "localhost";
  };
